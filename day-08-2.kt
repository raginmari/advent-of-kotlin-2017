...
fun solve(input: List<String>): Int {
  ...
  for (instruction in instructions) {
      ...
      // The modified value may have exceeded the current max register value
      val modifiedValue = registers.get(instruction.registerName) ?: 0
      maxRegisterValue = maxOf(maxRegisterValue, modifiedValue)
  }
